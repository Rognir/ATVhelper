...
public class RVAdapterPiensosAnimal extends RecyclerView.Adapter<RVAdapterPiensosAnimal.PersonViewHolder>{

    List<Categorias> persons;

    RVAdapterPiensosAnimal(List<Categorias> persons) {
    ...
    public class PersonViewHolder extends RecyclerView.ViewHolder implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            {
                case 0:
                    intent = new Intent(context, PiensosMedicamentososPerro.class);
                    break;
                case 1:
                    intent = new Intent(context, PiensosMedicamentososGato.class);
                    break;
                default:
